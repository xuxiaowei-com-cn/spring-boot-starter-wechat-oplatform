<div align="center" style="text-align: center;">
    <h1>spring-boot-starter-wechat-oplatform</h1>
    <h3>支持 OAuth 2.1 JWT 授权的微信开放平台开发组件</h3>
...
<div align="center" style="text-align: center;">
  ...
  <a target="_blank" href="https://s01.oss.sonatype.org/content/repositories/snapshots/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform">
    <img alt="snapshots" src="https://img.shields.io/maven-metadata/v?label=snapshots&metadataUrl=https://s01.oss.sonatype.org/content/repositories/snapshots/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform/maven-metadata.xml">
  </a>

  <a target="_blank" href="https://s01.oss.sonatype.org/content/repositories/releases/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform">
    <img alt="releases" src="https://img.shields.io/maven-metadata/v?label=releases&color=blue&metadataUrl=https://s01.oss.sonatype.org/content/repositories/releases/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform/maven-metadata.xml">
  </a>
  ...
  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform/blob/next/pom.xml">
...
- 当前流水线：[极狐GitLab](https://jihulab.com/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform/-/pipelines)
    - 国内版 GitLab，开源项目：不限制流水线使用时长
- 历史流水线：
    - [GitLab](https://gitlab.com/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform/-/pipelines)
    - [GitCode](https://gitcode.net/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform/-/pipelines)

## 发布

- [快照版](https://s01.oss.sonatype.org/content/repositories/snapshots/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform)
- [发布版](https://s01.oss.sonatype.org/content/repositories/releases/cn/com/xuxiaowei/boot/next/spring-boot-starter-wechat-oplatform)
...
[![Stargazers over time](https://starchart.cc/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform.svg)](https://starchart.cc/xuxiaowei-com-cn/spring-boot-starter-wechat-oplatform)
